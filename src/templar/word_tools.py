...
def insert_table(document: object,
    ...
    """
    The function takes data related to a table and uses it to create a table for the template_doc.
    The first row of data is assumed to be the table header.
    :param document: the template_doc the table will be added to.
